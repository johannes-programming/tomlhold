...
``Holder: Final[type[tomlhold.TOMLHolder]] = tomlhold.TOMLHolder``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``TOMLHolder`` is a subclass of ``datahold.OkayDict`` specifically for handling TOML.
...
``tomlhold.tests.test() -> unittest.TextTestResult``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
