...
class TestHolderCombined(unittest.TestCase):
    ...
    def test_nested_tables(self):
        ...
        self.assertEqual(self.holder['nested_table', 'key2', 'nested_key1'], 'nested_value1')
        self.assertEqual(self.holder['nested_table', 'key2', 'nested_key2', 'deep_key'], 'deep_value')
...
with several lines."""
        ...
        self.assertEqual(self.holder["section", "multiline_string_key"], multiline_string)
    ...
    def test_update_with_multiple_data_types(self):
        ...
        self.assertEqual(self.holder['datetime'], datetime.datetime(2023, 1, 1, 0, 0, 0))
    ...
    def test_holder_as_toml_string(self):
        ...
        """
        holder = Holder.fromstr(toml_data)
        toml_string = str(holder)
